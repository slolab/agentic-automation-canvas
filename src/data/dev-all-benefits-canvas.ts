 ...
 * multiple tasks to exercise display groups (same benefit type/metric in different tasks).
...
export const devAllBenefitsCanvas: CanvasData = {
  project: {
    ...
    description: 'Development aid RO-Crate with every benefit metric represented once and repeated across tasks to test display groups.',
    objective: 'Exercise all benefit types and display groups in collapsed view and Dashboard.',
    projectStage: 'Development',
    startDate: '2025-01-01',
    endDate: '2025-12-31',
    domain: ['Biomedical', 'AI'],
    keywords: ['automation', 'benefits', 'display groups'],
    headlineValue: 'All benefit types and display groups for dev',
...
/** Display groups for dev crate: sensible groupings so collapsed view and Dashboard show effect on load */
export const devBenefitDisplay: BenefitDisplayState = {
  displayGroups: [
    {
      id: 1,
      benefitType: 'time',
      metricId: 'processingTime',
      benefitRefs: [
        { requirementId: 'req-time', benefitIndex: 0 },
        { requirementId: 'req-time-2', benefitIndex: 0 },
      ],
    },
    {
      id: 2,
      ...
      metricId: 'errorRate',
      benefitRefs: [
        { requirementId: 'req-quality', benefitIndex: 0 },
        { requirementId: 'req-quality-2', benefitIndex: 0 },
      ],
    },
    {
      id: 3,
      ...
      metricId: 'complianceIncidents',
      benefitRefs: [
        { requirementId: 'req-risk', benefitIndex: 0 },
        { requirementId: 'req-risk-2', benefitIndex: 0 },
      ],
    },
    {
      id: 4,
      ...
      metricId: 'newCapability',
      benefitRefs: [
        { requirementId: 'req-enablement', benefitIndex: 0 },
        { requirementId: 'req-enablement-2', benefitIndex: 0 },
      ],
    },
    {
      id: 5,
      ...
      metricId: 'coverage',
      benefitRefs: [
        { requirementId: 'req-enablement', benefitIndex: 1 },
        { requirementId: 'req-enablement-2', benefitIndex: 1 },
      ],
    },
  ],
}

...
The current schema version is **0.9.0 (Beta)**. The schema follows semantic versioning:

- **Major versions** (1.0, 2.0): Breaking changes, incompatible with previous versions
- **Minor versions** (0.9, 0.10): Pre-release versions, may include breaking changes
- **Patch versions** (0.9.1, 0.9.2): Bug fixes, documentation updates

!!! warning "Beta Testing Phase"
    Version 0.9.0 is a **beta release** for testing and feedback. The schema structure and fields 

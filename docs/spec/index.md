...
The current schema version is **0.12.3 (Beta)**. The schema follows semantic versioning.

!!! warning "Beta Testing Phase"
    Version 0.12.3 is a **beta release** for testing and feedback. The schema structure and fields 
